...
class StaffDetailsScreen(QDialog):
    ...
    def loadStaffData(self):
        try:
            ...
            staff_data = SearchDB.searchStaffWithID(self.staff_id)
            print("DEBUG - Staff data:", staff_data)
            ...
            if not staff_data:
                ...
                self.loadMedicalData(staff_data)
    ...
    def loadMedicalData(self, data):
        ...
        # Medical view has: first_name, middle_name, last_name, username
        
        # Set header
        name = f"{data[1]} {data[2]} {data[3]}"
        self.staff_info_label.setText(f"Staff: {name}")
        ...
        basic_layout.addRow("Staff Username:", QLabel(data[4]))
