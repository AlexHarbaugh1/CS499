...
class ApplicationScreen(QDialog):
    ...
    def centerUI(self, screen_width, screen_height):
        ...
        self.logout.setGeometry(screen_width - 100, 70, 170, 70)
...
class AdminScreen(QDialog):
    ...
    def centerUI(self, screen_width, screen_height):
        ...
        # Center the title and subtitle
        title_width = 1200
        self.label.setGeometry((screen_width - title_width) // 2, 85, title_width, 110)
        self.label_2.setGeometry((screen_width - title_width) // 2, 205, title_width, 85)
        
        # Position logout button in top right
        self.logout.setGeometry(screen_width - 200, 70, 180, 80)
        
        # Center the gridLayoutWidget
        grid_width = 1000
        grid_height = 400
        self.gridLayoutWidget.setGeometry((screen_width - grid_width) // 2, 300, grid_width, grid_height)
