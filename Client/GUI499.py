...
@author: laure
"""
from SetupDB import check_database_exists, save_connection_params, load_connection_params
import hospitalDB
import InsertData
import UpdateDB
import psycopg2
...
@author: laure
"""
# Import the ConfigureDatabaseScreen instead of the InitializeDatabaseScreen
from SetupDB import check_database_exists, ConfigureDatabaseScreen
import hospitalDB
import InsertData
import UpdateDB
import psycopg2
...
if not check_database_exists():
    # Either the database doesn't exist or we can't connect with current parameters
    config_screen = ConfigureDatabaseScreen()
    widget.addWidget(config_screen)
