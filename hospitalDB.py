...
def run():
  ...
  # Create Table Users
    cursor2.execute("""CREATE TABLE Users
    ...
    cursor2.execute("""CREATE TABLE Patients
      (firstname varchar(255),
      lastname varchar(255),
      ...
      firstcontact varchar(255),
      firstcontactphonenumber varchar(255),
      secondcontact varchar(255),
      secondcontactphonenumber varchar(255),
      familydoctor varchar(255),
      insurancecarrier varchar(255),
      insuranceaccountnumber varchar(255),
      insurancegroupnumber varchar(255),
      billinginformation varchar(255),
      amountpaid varchar(255),
      amountowed varchar(255),
      amountpaidbyinsurance varchar(255));"""
      )
